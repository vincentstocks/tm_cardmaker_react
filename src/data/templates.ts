...
export const cardTemplates: CardTemplate[] = [
  {
    ...
    layers: [
      ...
      { type: 'text', name: 'Cost', data: '0', ...p(118, 151), width: pw(120), height: ph(66), color: '#000000', font: 'Prototype', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'center' },
      ...
      { type: 'text', name: 'Description', data: 'Card description\nMultiple lines\nand they can be much, much, much longer\n\'V space\' controls the spacing between lines', ...p(110, 770), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'left' },
      { type: 'text', name: 'Flavor Text', data: 'Flavor text!', ...p(413, 1005), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'italic', weight: 'bold', lineSpace: 4, justify: 'center' },
    ],
  },
  {
    id: 'green-big-bottom',
  ...
  },
  {
    ...
    layers: [
      ...
      { type: 'text', name: 'Description', data: 'Card description\nMultiple lines\nand they can be much, much, much longer\n\'V space\' controls the spacing between lines', ...p(100, 860), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'left' },
      { type: 'text', name: 'Flavor Text', data: 'Flavor text!', ...p(413, 1005), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'italic', weight: 'bold', lineSpace: 4, justify: 'center' },
      { type: 'block', name: 'Arrow', blockId: 'misc-arrow', ...p(355, 265), width: pw(116), height: ph(55), showOtherBg: false },
      { type: 'text', name: 'Effect Text', data: 'Effect or Action text!', ...p(413, 360), width: pw(500), height: ph(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'center' },
    ],
  },
  {
    id: 'blue-big-bottom',
  ...
  },
  {
    ...
    layers: [
      ...
      { type: 'text', name: 'Description', data: 'Card description\nMultiple lines\nand they can be much, much, much longer\n\'V space\' controls the spacing between lines', ...p(100, 891), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'left' },
      { type: 'text', name: 'Flavor Text', data: 'Flavor text!', ...p(413, 1005), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'italic', weight: 'bold', lineSpace: 4, justify: 'center' },
      { type: 'block', name: 'Arrow', blockId: 'misc-arrow', ...p(355, 265), width: pw(116), height: ph(55), showOtherBg: false },
      { type: 'text', name: 'Effect Text', data: 'Effect or Action text!', ...p(413, 360), width: pw(500), height: ph(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'center' },
    ],
  },
  {
    ...
    layers: [
      ...
      { type: 'text', name: 'Description', data: 'Card description\nMultiple lines\nand they can be much, much, much longer\n\'V space\' controls the spacing between lines', ...p(100, 810), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'left' },
      { type: 'text', name: 'Flavor Text', data: 'Flavor text!', ...p(413, 1005), width: TW, height: ph(24), color: '#000000', font: 'Pagella', style: 'italic', weight: 'bold', lineSpace: 4, justify: 'center' },
    ],
  },
  {
  ...
  },
  {
    ...
    layers: [
      ...
      { type: 'text', name: 'Description', data: 'Card description\nMultiple lines\nand they can be much, much, much longer\n\'V space\' controls the spacing between lines', ...l(110, 560), width: LTW, height: lh(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'left' },
      { type: 'text', name: 'Flavor Text', data: 'Flavor text!', ...l(563, 723), width: LTW, height: lh(24), color: '#000000', font: 'Pagella', style: 'italic', weight: 'bold', lineSpace: 4, justify: 'center' },
    ],
  },
  {
    id: 'corporation',
    ...
    layers: [
      ...
      { type: 'text', name: 'Description', data: 'Card description\nMultiple lines\nand they can be much, much, much longer\n\'V space\' controls the spacing between lines', ...l(110, 330), width: lw(470), height: lh(24), color: '#000000', font: 'Pagella', style: 'normal', weight: 'normal', lineSpace: 4, justify: 'left' },
